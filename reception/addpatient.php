	 ...
	 ?>
		<div class="right"><br>
			...
			<center>
				...
				<input type="tel" name="phone" class="form" placeholder="Enter Phone number" maxlength="10" pattern="[6-9]{1}[0-9]{9}"
				 title="Must contain 10 digits and does not start with 0,1,2,3,4,5" required="required"><br><br>
				<input type="text" name="address" class="form" placeholder="Enter Address" required="required"><br><br>
				<select name="gender" class="form" required>
